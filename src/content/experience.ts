...
// Add, remove, or edit roles here — most recent first.
export const experience: Experience[] = [
  {
    ...
    points: [
      ...
      "Contribute to core system architecture decisions, assist in debugging production issues, and manage the deployment of backend services using AI-assisted workflows.",
      "Take ownership of full-cycle feature development, executing robust unit and integration testing to guarantee high-quality code.",
    ],
  },
  {
    id: "google-aicte",
